...
autocmd filetype nerdtree syn match config_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match css_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match favicon_icon ## containedin=NERDTreeFlags
...
autocmd filetype nerdtree syn match json_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match jsx_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match license_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match lock_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match md_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match npm_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match procfile_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match rest_icon #ﬥ# containedin=NERDTreeFlags
autocmd filetype nerdtree syn match ruby_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match scss_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match sh_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match svg_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match tags_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match ts_icon #ﯤ# containedin=NERDTreeFlags
autocmd filetype nerdtree syn match vim_icon ## containedin=NERDTreeFlags
autocmd filetype nerdtree syn match vue_icon #﵂# containedin=NERDTreeFlags
